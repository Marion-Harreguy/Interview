...
const UserLibraryRight = () => {
  ...
  <div className="tuto">
    ...
    <div className="tuto__perso">
      ...
      <p><span className="tuto__categoryplus tuto__round" />Créez vos catégories personnelles, pour ranger vos documents</p>
      <p>Séléctionnez-les ou non afin de choisir ce qui apparait dans votre bibliothèque</p>
      </div>
    </div>
    ...
    <div className="tuto__write">
      ...
      <br/><em>Pour rappel, libre de droit signifie que les lecteurs peuvent citer librement vos entretiens — tout en en citant obligatoirement la source. Si vous ne souhaitez pas donner cette possibilité aux lecteurs, ils devront vous contacter et obtenir votre accord pour avoir accès à ces options.</em></p>
      ...
      <p><span className="tuto__export" />Publiez l’entretienil sera disponible dans les résultats du moteur de recherche.</p>
       <p><span className="tuto__content">></span>Entrez le contexte de l'entretien (qui constituera une introduction)</p>
       <p><span className="tuto__question" />Entrez les questions (posées par l'auteur)</p>
       <p><span className="tuto__answer" />Entrez les réponses (fournies par l'enquêté)</p>
       </div>
    </div>
    <div className="tuto__search">
      ...
      <p>Entrez autant de critères que vous le souhaitez.
      </p>
      <p>
        Visualisez les résultats selon trois modes :</p>
        <p><span className="tuto__list tuto__round tuto__mode" />Liste: par ordre alphabétique des titres.</p>
        <p><span className="tuto__planet tuto__round tuto__mode"/>Cartographie: lieux du déroulement des entretiens, ou des structure liées aux entretiens</p>
        <p><span className="tuto__clock tuto__round tuto__mode"/>Chronologie: dates du déroulement des entretiens</p>
